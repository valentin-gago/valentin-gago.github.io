...
function initCanvas() {
  ...
  backgroundImg.src   = "../img./wall.jpg";
  naveImg.src         = "../img./shipspace.jpg";
  enemyImg.src = "../img./enemy1.jpg";
  enemy2Img.src = "../img./enemy1.jpg";  
  ...
  let enemyTemplate = function (options) {
    return {
      ...
      w: options.w || "",
      h: options.h || "",
      image: options.image || naveImg,
    };
  };
  var enemies = [
    new enemyTemplate({ id: "enemy1", x: 90, y: -20, w: 50, h: 30 }),
  ...
  function launcher() {
    ...
    this.render = function () {
      ...
      ctx.drawImage(naveImg, this.x, this.y, 100, 90);
